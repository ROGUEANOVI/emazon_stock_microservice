...
public class BrandValidationMessages {
    ...
    public static final String INVALID_BRAND_NAME_NULL_EMPTY_OR_BLANK = "Brand name cannot be null, empty or only blank characters";

    public static final String INVALID_BRAND_DESCRIPTION_SIZE = "Brand description cannot be longer than 120 characters";
    public static final String INVALID_BRAND_DESCRIPTION_NULL_EMPTY_OR_BLANK = "Brand description cannot be empty or only blank characters";
