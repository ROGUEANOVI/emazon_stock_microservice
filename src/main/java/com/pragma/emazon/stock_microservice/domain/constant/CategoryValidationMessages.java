...
public class CategoryValidationMessages {
    ...
    public static final String INVALID_CATEGORY_NAME_NULL_EMPTY_OR_BLANK = "Category name cannot be null, empty or only blank characters";

    public static final String INVALID_CATEGORY_DESCRIPTION_SIZE = "Category description cannot be longer than 90 characters";
    public static final String INVALID_CATEGORY_DESCRIPTION_NULL_EMPTY_OR_BLANK = "Category description cannot be null, empty or only blank characters";
